...
// Returns the value of max_splits_
size_t SplittingFIFOTaskQueue::GetMaxTasksPerSplit(void) const {
  return max_splits_;
}

// Sets the value of min_vector_size_
...
// Returns the value of min_vector_size_
